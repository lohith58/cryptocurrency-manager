...
api_request = requests.get("https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=5&convert=USD&CMC_PRO_API_KEY=87bd5301-c6ee-416e-9a13-4a709eddc03d")
...
print("Total Profit/Loss For CryptoCurrency-Tracker:", "${0:.2f}".format(total_pl))
