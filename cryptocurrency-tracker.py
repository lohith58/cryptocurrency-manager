...
pycrypto = Tk()
pycrypto.title("CryptoCurrency-Tracker")
...
def app_nav():
    def clear_all():
        ...
        messagebox.showinfo("Notification", "Cleared -Pls Add New Coins")
        reset()
...
def my_portfolio():
    api_request = requests.get("https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=300&convert=USD&CMC_PRO_API_KEY=87bd5301-c6ee-416e-9a13-4a709eddc03d")
